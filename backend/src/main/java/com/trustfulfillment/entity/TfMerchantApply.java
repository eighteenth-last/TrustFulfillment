 ...
 * 商户申请实体
 */
@TableName("tf_merchant_apply")
public class TfMerchantApply {
    ...
    private String auditRemark;       // 审核备注/拒绝原因
    ...
    private String userName;  // 申请用户昵称
    @TableField(exist = false)
    private String userPhone; // 申请用户手机号
